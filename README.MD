...
[![Go Doc](https://godoc.org/github.com/csrgxtu/gf?status.svg)](https://godoc.org/github.com/csrgxtu/gf)
[![Build Status](https://travis-ci.org/gogf/gf.svg?branch=master)](https://travis-ci.org/gogf/gf)
[![Go Report](https://goreportcard.com/badge/github.com/csrgxtu/gf?v=1)](https://goreportcard.com/report/github.com/csrgxtu/gf)
[![Code Coverage](https://codecov.io/gh/gogf/gf/branch/master/graph/badge.svg)](https://codecov.io/gh/gogf/gf/branch/master)
[![Production Ready](https://img.shields.io/badge/production-ready-blue.svg)](https://github.com/csrgxtu/gf)
[![License](https://img.shields.io/github/license/gogf/gf.svg?style=flat)](https://github.com/csrgxtu/gf)
...
# Installation
```
go get -u -v github.com/csrgxtu/gf
```
suggested using `go.mod`:
```
require github.com/csrgxtu/gf latest
```
...
Here's the most popular Golang frameworks and libraries performance testing result in `WEB Server`. Performance testing cases source codes are hosted at: https://github.com/csrgxtu/gf-performance
...
* GoDoc API: https://godoc.org/github.com/csrgxtu/gf
...
- Issues：https://github.com/csrgxtu/gf/issues
...
# Contributors
This project exists thanks to all the people who contribute. [[Contributors](https://github.com/csrgxtu/gf/graphs/contributors)].
<a href="https://github.com/csrgxtu/gf/graphs/contributors"><img src="https://opencollective.com/goframe/contributors.svg?width=890&button=false" /></a>
